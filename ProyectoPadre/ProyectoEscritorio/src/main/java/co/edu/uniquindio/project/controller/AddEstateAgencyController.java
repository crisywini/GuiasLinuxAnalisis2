...
public class AddEstateAgencyController {
    ...
    void handleAddButton(ActionEvent event) {
    	if(isInputValid()) {
    		...
    		try {
				delegate.createEstateAgency(nameField.getText(), codeField.getText(), userField.getText(), passwordField.getText(), addressField.getText());
				InitController.showAlert("Se ha creado la nueva inmobiliaria: "+nameField.getText(), "INFORMACIÓN", "", AlertType.INFORMATION);
