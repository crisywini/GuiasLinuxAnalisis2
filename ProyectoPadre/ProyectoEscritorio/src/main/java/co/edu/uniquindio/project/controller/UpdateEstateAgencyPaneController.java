...
/**
 * The class UpdateEstateAgencyPaneController
 *
...
public class UpdateEstateAgencyPaneController {
	...
	void handleUpdateButton(ActionEvent event) {
		if (isInputValid()) {
			...
			try {
				...
				InitController.showAlert("Se ha actualizado la inmobiliaria: " + ea.getName(), "INFORMACIÓN", "",
	...
	/**
	 * Sets the code estate agency.
	 *
	 * @param codeEstateAgency the new code estate agency
	 */
